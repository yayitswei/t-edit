...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13412 = 0;while(true){
var m_13413 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13413 == null))
{} else
{m_13413.call(null);
if((count_13412 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13414 = (count_13412 + 1);
count_13412 = G__13414;
continue;
}
} else
{}
