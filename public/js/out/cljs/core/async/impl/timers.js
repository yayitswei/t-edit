...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13377 = 0;while(true){
if((i_13377 < arr.length))
{(arr[i_13377] = null);
{
var G__13378 = (i_13377 + 1);
i_13377 = G__13378;
continue;
}
} else
...
{var i_13384 = (self__.level + 1);while(true){
if((i_13384 <= (new_level + 1)))
{(update[i_13384] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13386 = 0;while(true){
if((i_13386 <= self__.level))
{var links_13387 = (update[i_13386]).forward;if(((links_13387[i_13386]) === x__$1))
{(links_13387[i_13386] = (x__$1.forward[i_13386]));
{
var G__13388 = (i_13386 + 1);
i_13386 = G__13388;
continue;
}
} else
{{
var G__13389 = (i_13386 + 1);
i_13386 = G__13389;
continue;
}
}
