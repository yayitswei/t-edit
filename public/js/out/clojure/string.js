...
{{
var G__10710 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10710;
continue;
}
} else
...
{var pred__10714 = cljs.core._EQ_;var expr__10715 = limit;if(cljs.core.truth_(pred__10714.call(null,1,expr__10715)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10714.call(null,2,expr__10715)))
...
var G__10717 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10718 = (limit__$1 - 1);
var G__10719 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10717;
limit__$1 = G__10718;
parts = G__10719;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10721 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10721))
{var replacement_10722 = temp__4090__auto___10721;buffer.append([cljs.core.str(replacement_10722)].join(''));
} else
{buffer.append(ch);
}
{
var G__10723 = (index + 1);
index = G__10723;
continue;
}
}
