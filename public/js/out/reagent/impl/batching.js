...
{var C_10646 = (a[i]);if(cljs.core.truth_(C_10646.cljsIsDirty))
{C_10646.forceUpdate();
} else
{}
{
...
reagent.impl.batching.dispose = (function dispose(C){var ratom_10648 = C.cljsRatom;if(!((ratom_10648 == null)))
{reagent.ratom.dispose_BANG_.call(null,ratom_10648);
} else
{}
